...
export { default as BeerIndicator } from './BeerIndicator';
...
export { default as ShotsIndicator } from './ShotsIndicator';
export { default as ShotsWarning } from './ShotsWarning';
